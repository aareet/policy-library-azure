...
3. Enable the policies feature in Terraform Cloud (currently available on all Trial, Team & Governance, Business and Flex plans).
4. Gain access to a [supported](https://www.terraform.io/docs/cloud/vcs/index.html#supported-vcs-providers) version control system (VCS) provider.

> **NOTE:** Terraform Policies is only available to customers that are on an eligible Terraform Cloud plan. You can learn more about changing your payment plan by reviewing the [Changing Your Payment Plan](https://www.terraform.io/docs/cloud/paid.html#changing-your-payment-plan) sections in the Terraform Cloud documentation.
